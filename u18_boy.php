...
$sql= "SELECT * FROM `user_profile` where date_naissance between '15' and '17' and sexe ='M' order by code asc";
...
<li class="breadcrumb-item active">U-18 Garçons</li>
</ul>
