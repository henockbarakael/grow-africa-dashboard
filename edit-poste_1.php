...
try {
  ...
  echo "Connection failed: " . $e->getMessage();
    ...
    $acc=$user->data()->code;
      ...
      $poste_1 = Input::get('poste_1');
   
      $sql = "UPDATE user_profile SET poste_1 = :poste_1  WHERE code= '$acc'";
      $stmt = $conn->prepare($sql);

      $stmt-> bindParam (':poste_1', $poste_1, PDO::PARAM_STR);
			...
			<div class="card-body">
				<form action="" method="POST" autocomplete="off">
					<div class="form-group">
						...
						<input type="text" class="form-control" required name="poste_1" placeholder="Entrez votre prénom" />
					</div>
					<div class="row">
              <div class="col-sm-12">
                  <button type="submit"  class="btn btn-primary">Je mets à jour mon prémier poste</button>
