...
try {
  ...
  echo "Connection failed: " . $e->getMessage();
    ...
    $acc=$user->data()->code;
      ...
      $sql = "UPDATE user_profile SET  telephone = :phone WHERE code= '$acc'";
			...
			<div class="card-body">
				<form action="" method="POST" autocomplete="off">
					<div class="form-group">
						...
						<input type="tel" class="form-control" required name="phone" placeholder="Ex. : 0828584688" />
					</div>
					<div class="row">
              <div class="col-sm-12">
                  <button type="submit"  class="btn btn-primary">Je mets à jour mon numéro</button>
