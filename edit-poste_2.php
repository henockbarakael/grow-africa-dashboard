...
try {
  ...
  echo "Connection failed: " . $e->getMessage();
    ...
    $acc=$user->data()->code;
      ...
      $poste_2 = Input::get('poste_2');
   
      $sql = "UPDATE user_profile SET poste_2 = :poste_2  WHERE code= '$acc'";
      $stmt = $conn->prepare($sql);

      $stmt-> bindParam (':poste_2', $poste_2, PDO::PARAM_STR);
			...
			<div class="card-body">
				<form action="" method="POST" autocomplete="off">
					<div class="form-group">
						...
						<input type="text" class="form-control" required name="poste_2" placeholder="Entrez votre prénom" />
					</div>
					<div class="row">
              <div class="col-sm-12">
                  <button type="submit"  class="btn btn-primary">Je mets à le deuxième poste</button>
