...
$sql= "SELECT * FROM `user_profile` where date_naissance between '13' and '17' and sexe ='F' order by code asc";
...
<li class="breadcrumb-item active">U-18 Filles</li>
</ul>
