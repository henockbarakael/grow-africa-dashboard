...
$sql= "SELECT * FROM `user_profile` where date_naissance between '18' and '25' and sexe ='F' order by code asc";
...
<li class="breadcrumb-item active">U-21 Filles</li>
</ul>
